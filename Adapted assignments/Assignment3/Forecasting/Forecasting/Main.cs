...
namespace Forecasting
{
    public partial class Main : Form
    {
        public Main()
        {
            ...
            chart_forcasting.ChartAreas[0].AxisY.Minimum = 0;

            //// SES
            //float sesSmoothingCoefficient;
            //float sesSquaredError;
            //var sesSeries = chart.GetSeries(SeriesNames.Ses).FindForecastSesWithLowestError(0.01f, chart.GetSeries(SeriesNames.Ses).Points.Count + 8, out sesSmoothingCoefficient, out sesSquaredError);
            ...
            var desSeries = chart.GetSeries(SeriesNames.Des).FindForecastDesWithLowestError(0.01f, chart.GetSeries(SeriesNames.Des).Points.Count + 8, out desDataCoefficient, out desTrendCoefficient, out desSquaredError);
        ...
        private void chart_forcasting_Click(object sender, EventArgs e)
        {
